...
- [ ] 14.2 重写统一主源模型：删除未经BSR筛选的整体盘分支，使用BSR候选父ASIN主池作为四部分唯一统计范围。
- [ ] 14.3 重建XLSX公式链、HTML、JSON、Markdown和构建清单，确保PP+高客单价逐月回加整体，GENIMO来自同一主池。
- [ ] 14.4 重新执行2025.09、2026.07、全部公式、缺失状态、分层、进留退、规划和跨文件验收，并记录MOM最终分母月份。
