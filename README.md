...
数据覆盖必须先看 `93_数据校验`：主源共有 56,207 行、去重后 53,213 个 Listing；2025-10 至 2026-07 子表为空，2022 年为 7/12 月部分覆盖、2025 年为 9/12 月部分覆盖、2026 年为无数据。该覆盖边界来自原始工作簿，不代表业务市场为零。

`outputs/20260909-formula-market-analysis/户外地垫市场分析-公式版-20260909.xlsx` 是按旧版流程生成的历史文件。当前 SPEC 2.0 可回勾文件使用上面列出的 12 张证据和结果表；整体市场由 PP 和非 PP 组成，GENIMO 是整体市场中的品牌视角。由于主源 2025-10 至 2026-07 子表为空，涉及 2026 的业务验收仍需补齐正确源数据后重新生成。
