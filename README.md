...
`outputs/20260909-formula-market-analysis/户外地垫市场分析-公式版-20260909.xlsx` 是按旧版流程生成的历史文件。新版仍可沿用 20 个工作表作为支撑载体，但必须先按 `docs/SPEC.md` 2.0 的原始主源、BSR筛选顺序、四部分结构和图表要求重新生成，完成后才能作为领导验收文件。整体市场由PP和非PP组成；GENIMO是整体市场中的品牌视角。
